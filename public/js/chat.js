...
(function () {
  ...
  socket.on('toast', (data) => {
    ...
    message.placeholder = "წერილი დაწერეთ აქ..";
    message.focus();
    resetTimer();
  });
    ...
    if (socket.id != data.senderId) {
      if (data.typingStatus === true) {
        if (typeMessageShown === false) {
          let template = `<div id="typing"><div class="toast-top-center" id="toast-container"><div class="toast msg_div grey" style="width:230px"><div class="toast-title white-text">ის წერს . . .</div></div></div>`;
